...
export default function Navbar() {
    return (
        <div className="flex w-full h-[60px] px-8 py-4 justify-between items-center bg-background">
            <div className="flex w-full max-w-[400px] h-full items-center">
                <img src={Logo} className="flex w-fit max-h-[50px] mr-4" />
                <div className="">
                    <p className="font-semibold text-2xl text-text">BUNNY</p>
            ...
            <div className="flex w-full max-w-[400px] justify-end items-center">
                <p className="font-semibold text-xl text-text mx-auto">ABOUT</p> {/* About Page Component */}
                <p className="font-semibold text-xl text-text mx-auto">CREWS</p> {/* Crew Page Component */}
                <div className="flex w-fit h-full mx-auto items-center max-w-[200px]"> 
                    ...
                    <div className="ml-4">
                        <p className="font-semibold text-lg text-text">KraSuang</p> {/* Username */}
